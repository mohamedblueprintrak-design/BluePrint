...
export function DashboardSkeleton({ className }: DashboardSkeletonProps) {
  return (
    <div className={`space-y-6 ${className ?? ''}`}>
      {/* Welcome banner */}
      <div className="relative overflow-hidden rounded-xl h-32 animate-pulse bg-muted" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Recent list */}
        <div className="lg:col-span-2 bg-card border border-border rounded-xl p-6 space-y-2">
          <div className="flex items-center justify-between mb-4">
            <div className="space-y-2">
              <div className="h-5 w-24 animate-pulse bg-muted rounded-md" />
              <div className="h-3 w-40 animate-pulse bg-muted rounded-md" />
            </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-card border border-border rounded-xl p-6 space-y-3">
            <div className="h-5 w-28 animate-pulse bg-muted rounded-md" />
          ...
          <div className="bg-card border border-border rounded-xl p-6 flex flex-col items-center justify-center">
            <div className="h-12 w-12 animate-pulse bg-muted rounded-full mb-3" />
            <div className="h-8 w-16 animate-pulse bg-muted rounded-md mb-2" />
            <div className="h-3 w-32 animate-pulse bg-muted rounded-md" />
          </div>
        </div>
      </div>
