        ...
        <div className="mb-6 p-5 rounded-xl bg-gradient-to-br from-blue-500/10 via-violet-500/10 to-cyan-500/10 border border-blue-500/30 shadow-lg shadow-blue-500/5">
          ...
          <div className="grid grid-cols-4 gap-2 sm:gap-3">
            {[
              ...
              { role: language === 'ar' ? 'مشاهد' : 'Viewer', user: 'viewer', pass: 'Admin@123456', color: 'from-slate-500/20 to-slate-600/10 border-border/30 hover:border-border hover:from-slate-500/30', icon: '👁️', desc: language === 'ar' ? 'عرض فقط' : 'Read Only' },
            ].map((demo) => (
              <button
                key={demo.user}
                type="button"
              ...
              >
                ...
                <span className="text-xs font-semibold text-foreground">{demo.role}</span>
                <span className="text-[10px] text-muted-foreground leading-tight text-center">{demo.desc}</span>
          ...
          <Tabs defaultValue="login" className="w-full">
            <CardHeader className="pb-0">
              <TabsList className="grid w-full grid-cols-2 bg-muted">
                <TabsTrigger value="login" className="data-[state=active]:bg-blue-600 data-[state=active]:text-foreground">
                  {t.login}
                </TabsTrigger>
                <TabsTrigger value="register" className="data-[state=active]:bg-blue-600 data-[state=active]:text-foreground">
                  {t.register}
                </TabsTrigger>
              </TabsList>
            </CardHeader>
            ...
            <CardContent className="pt-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="ps-10 bg-muted border-border text-foreground placeholder:text-muted-foreground focus:border-blue-500 focus:ring-blue-500/20"
                        required
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="ps-10 pe-10 bg-muted border-border text-foreground placeholder:text-muted-foreground focus:border-blue-500 focus:ring-blue-500/20"
                        required
                      />
                      <button
                        type="button"
                        onClick={() => setShowLoginPassword(!showLoginPassword)}
                        className="absolute end-3 top-3 text-muted-foreground hover:text-foreground/80 transition-colors"
                      >
                        {showLoginPassword ? (
              ...
              <TabsContent value="register">
                <form onSubmit={handleRegister} className="space-y-4">
                  <div className="space-y-2">
                    <Label htmlFor="register-fullname" className="text-foreground/80">
                      {t.fullName}
                    </Label>
                    <div className="relative">
                      <User className="absolute start-3 top-3 h-4 w-4 text-muted-foreground" />
                          ...
                          <Eye className="h-4 w-4" />
                            ...
                            <div className="space-y-2">
                              ...
                              <select
                                ...
                                className="w-full px-3 py-2 rounded-lg bg-muted border border-border text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-blue-500"
                              >
