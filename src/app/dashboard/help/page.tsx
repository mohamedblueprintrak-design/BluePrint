  ...
  return (
    <div className="space-y-6" dir="rtl">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">مركز المساعدة</h1>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card className="hover:shadow-md transition-shadow cursor-pointer">
          <CardContent className="p-4 text-center">
            ...
            <h3 className="font-medium text-gray-900">الدليل الشامل</h3>
            <p className="text-sm text-gray-500">تعلم جميع الميزات</p>
          </CardContent>
        </Card>
        ...
        <Card className="hover:shadow-md transition-shadow cursor-pointer">
          <CardContent className="p-4 text-center">
            ...
            <h3 className="font-medium text-gray-900">فيديوهات تعليمية</h3>
            <p className="text-sm text-gray-500">شروحات مصورة</p>
          </CardContent>
        </Card>
        ...
        <Card className="hover:shadow-md transition-shadow cursor-pointer">
          <CardContent className="p-4 text-center">
            ...
            <h3 className="font-medium text-gray-900">المجتمع</h3>
            <p className="text-sm text-gray-500">اطرح سؤالك</p>
          </CardContent>
        </Card>
        ...
        <Card className="hover:shadow-md transition-shadow cursor-pointer">
          <CardContent className="p-4 text-center">
            ...
            <p className="text-sm text-gray-500">دعم مباشر</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="bg-blue-50 border-blue-200">
        <CardContent className="p-6">
          <div className="text-center">
            <h3 className="text-lg font-semibold text-gray-900 mb-2">لم تجد ما تبحث عنه؟</h3>
            <p className="text-gray-600 mb-4">فريق الدعم الفني جاهز لمساعدتك</p>
