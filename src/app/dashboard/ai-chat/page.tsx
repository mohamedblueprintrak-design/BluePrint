    ...
    <div className="space-y-6" dir={isAr ? 'rtl' : 'ltr'}>
      ...
      <Tabs defaultValue="ai-chat" className="space-y-6">
        <TabsList className="bg-muted border border-border">
          <TabsTrigger value="ai-chat" className="data-[state=active]:bg-violet-600 data-[state=active]:text-foreground">
            <Bot className="w-4 h-4 me-2" />
            {isAr ? 'المساعد الذكي' : 'AI Chat'}
          </TabsTrigger>
          <TabsTrigger value="knowledge" className="data-[state=active]:bg-emerald-600 data-[state=active]:text-foreground">
            <BookOpen className="w-4 h-4 me-2" />
            {isAr ? 'قاعدة المعرفة' : 'Knowledge Base'}
          </TabsTrigger>
          <TabsTrigger value="help" className="data-[state=active]:bg-blue-600 data-[state=active]:text-foreground">
