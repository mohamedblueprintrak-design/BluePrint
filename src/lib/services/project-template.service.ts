 ...
 *
 * Phases: 12 phases matching the Excel office system (total 43 days)
 */
 ...
 *
 * Phases: 24 phases across all MEP sub-disciplines
 */
 ...
 *
 * Phases: 14 phases matching the government department workflow
 */
export function createGovernmentTemplate(): WorkflowPhaseTemplateData[] {
  return [
    ...
    },
    {
      ...
      phaseCategory: 'GOVERNMENT',
      description: 'Create the government submission case',
      descriptionAr: 'إنشاء المعاملة الحكومية',
      slaDays: 1,
      slaWarningDays: 1,
      order: 3,
      dependsOnOrder: 2,
    ...
    },
    {
      ...
      phaseCategory: 'GOVERNMENT',
      description: 'Site demarcation and leveling survey',
      descriptionAr: 'تحديد الموقع ومسح التسوية',
      slaDays: 1,
      slaWarningDays: 1,
      order: 8,
      dependsOnOrder: 7,
    ...
    {
      phaseType: 'CHOOSE_CONTRACTOR',
      phaseTypeAr: 'اختيار المقاول',
      phaseCategory: 'GOVERNMENT',
      description: 'Select and assign contractor for the project',
      descriptionAr: 'اختيار وتعيين المقاول للمشروع',
      slaDays: 12,
      slaWarningDays: 8,
      order: 9,
      dependsOnOrder: 8,
    ...
    {
      phaseType: 'ISSUE_LICENSE',
      phaseTypeAr: 'استخراج الرخصة',
      phaseCategory: 'GOVERNMENT',
      description: 'Issue the building permit/license',
      descriptionAr: 'استخراج رخصة البناء',
      slaDays: 7,
      slaWarningDays: 5,
      order: 10,
      dependsOnOrder: 9,
    ...
    {
      phaseType: 'SEWA_DEWA',
      phaseTypeAr: 'موافقة هيئة الكهرباء والماء',
      phaseCategory: 'GOVERNMENT',
      description: 'FEWA/DEWA approval for electrical and water connections',
      descriptionAr: 'موافقة هيئة الكهرباء والماء للتوصيلات الكهربائية والمائية',
      slaDays: 6,
      slaWarningDays: 4,
      order: 11,
      dependsOnOrder: 7,
    ...
    {
      phaseType: 'ETISALAT_APPROVAL',
      phaseTypeAr: 'موافقة الاتصالات',
      phaseCategory: 'GOVERNMENT',
      description: 'Etisalat telecom approval',
      descriptionAr: 'موافقة الاتصالات',
      slaDays: 4,
      slaWarningDays: 3,
      order: 12,
      dependsOnOrder: 7,
    ...
    {
      phaseType: 'CD_DESIGN_APPROVAL',
      phaseTypeAr: 'تصميم الدفاع المدني',
      phaseCategory: 'GOVERNMENT',
      description: 'Civil Defense design review and approval',
      descriptionAr: 'مراجعة واعتماد تصميم الدفاع المدني',
      slaDays: 5,
      slaWarningDays: 3,
      order: 13,
      dependsOnOrder: 7,
    ...
    {
      phaseType: 'CIVIL_DEFENSE',
      phaseTypeAr: 'اعتماد الدفاع المدني',
      phaseCategory: 'GOVERNMENT',
      description: 'Final Civil Defense approval certificate',
      descriptionAr: 'شهادة الموافقة النهائية من الدفاع المدني',
      slaDays: 7,
      slaWarningDays: 5,
      order: 14,
      dependsOnOrder: 13,
